...
import { useState, useCallback, forwardRef, useContext, useLayoutEffect, useRef, createContext, useMemo, Component, Fragment, useEffect } from "react";
...
const ReactSelect = ({ components: components2, styles, error, ariaErrorMessage, ...props }) => {
    ...
    StateManagedSelect$1,
    {
      ...
      styles: {
        ...
        multiValue: (base) => ({
          ...
          borderRadius: "4px",
          fontSize: "16px"
          // Font size for selected values
        }),
        multiValueLabel: (base) => ({
          ...base,
          color: "#ffffff",
          fontSize: "16px"
          // Font size for multi-value labels
        }),
...
const MultiSelect = ({
  ...
  const { onChange: onChange2, value, error } = useField(name);
  ...
  const sanitizedValue = useMemo(() => {
    ...
    if (parsedValue.includes("select_all")) {
      return possibleOptions.filter(({ value: value2 }) => value2 !== "select_all");
    }
  ...
  return /* @__PURE__ */ jsx$1(
    Field.Root,
    {
      ...
      children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 1, children: [
        /* @__PURE__ */ jsx$1(Field.Label, { children: intlLabel?.id ? formatMessage(intlLabel) : label }),
        /* @__PURE__ */ jsx$1(
          StyledReactSelect,
          {
            isSearchable: true,
        ...
        /* @__PURE__ */ jsx$1(Field.Hint, {}),
        /* @__PURE__ */ jsx$1(Field.Error, {})
      ] })
    }
  );
};
